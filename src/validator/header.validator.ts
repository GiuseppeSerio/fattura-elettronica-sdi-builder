...
import { validateDatiTrasmissione, validateCedentePrestatore, validateCessionarioCommittente } from './rules/index.js';
 ...
 */
function validateCodiceDestinatario(header: FatturaElettronicaHeader): FieldError[] {
